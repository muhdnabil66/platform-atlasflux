      ...
      <div className="relative z-10 flex flex-col">
        ...
        <div className="w-full flex justify-center px-6 mt-16">
          <div className="w-full max-w-4xl">
            ...
            >
              Meet AtlasFlux Nenas Flash.
              <br />
              Reasoning, web search and multimodal input through one stable model ID.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <Link
                href="/sign-in"
                className="inline-flex items-center px-5 py-2.5 bg-white text-zinc-900 font-medium rounded-lg hover:bg-zinc-100 transition-colors text-sm cursor-pointer"
                aria-label="Sign in to get an API key"
              >
                Get API key
              </Link>
              <a
                ...
                className="text-zinc-300 font-medium hover:text-white transition-colors flex items-center gap-2 text-sm cursor-pointer underline-offset-4 hover:underline"
              >
                <span className="text-zinc-500">New:</span> OpenAI-compatible API
